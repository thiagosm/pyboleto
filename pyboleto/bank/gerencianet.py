...
class BoletoGerenciaNet(BoletoData):
    '''
        Gera Dados necessários para criação de boleto para o banco GerenciaNet
    '''
    ...
    def __init__(self):
        super(BoletoGerenciaNet, self).__init__()

        self.codigo_banco = "364"
        self.logo_image = "logo_gerencianet.jpg"
        self.carteira = '0001'
